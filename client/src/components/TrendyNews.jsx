...
function TrendyNews() {
    ...
    const currentNews = trendyNews.slice(indexOfFirstNews, indexOfLastNews);

    const nextPage = () => {
        if (indexOfLastNews < trendyNews.length) {
        ...
        <section className="2xl:container 2xl:mx-auto xl:mx-32">
            <div className="flex justify-between py-6">
                ...
                <div className="flex justify-between gap-4">
                    ...
                    <button
                        onClick={nextPage}
                        disabled={indexOfLastNews >= trendyNews.length}
                        className="w-[40px] h-[40px] bg-gray rounded-xl flex items-center justify-center red-hover"
                    >
                        <svg
                            width="24"
