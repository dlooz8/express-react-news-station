    ...
    return (
        <div className='flex justify-between container mx-auto my-8 gap-2 items-center align-middle font-medium'>
            ...
            { isAuth ?
                <div className="dropdown">
                    <button className="dropbtn flex justify-between gap-4 items-center">
                        <img className='object-cover w-[48px] h-[48px] rounded-xl' src={ isUser.avatar_url } alt="avatar" />
                    ...
                    <div className="dropdown-pages p-4 gap-4 left-4">
                        <Link to='/createnews' className='flex red-hover items-center gap-2'>
                            <svg width="16" height="16" viewBox="2 0 16 16" fill="#3E3232" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.3125 9.0625C11.9648 9.0625 14.125 11.2227 14.125 13.875C14.125 14.3672 13.7148 14.75 13.25 14.75H2.75C2.25781 14.75 1.875 14.3672 1.875 13.875C1.875 11.2227 4.00781 9.0625 6.6875 9.0625H9.3125ZM3.1875 13.4375H12.7852C12.5664 11.7148 11.0898 10.375 9.3125 10.375H6.6875C4.88281 10.375 3.40625 11.7148 3.1875 13.4375ZM8 7.75C6.05859 7.75 4.5 6.19141 4.5 4.25C4.5 2.33594 6.05859 0.75 8 0.75C9.91406 0.75 11.5 2.33594 11.5 4.25C11.5 6.19141 9.91406 7.75 8 7.75ZM8 2.0625C6.76953 2.0625 5.8125 3.04688 5.8125 4.25C5.8125 5.48047 6.76953 6.4375 8 6.4375C9.20312 6.4375 10.1875 5.48047 10.1875 4.25C10.1875 3.04688 9.20312 2.0625 8 2.0625Z" fillOpacity="0.75"/>
                            </svg>
                            <h6 className='red-hover'>Профиль</h6>
                        </Link>
                        <Link to='/bookmarks' className='flex red-hover items-center gap-2'>
                            <svg width="12" height="15" viewBox="0 0 12 15" fill="#3E3232" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.9375 0.75C10.6484 0.75 11.25 1.35156 11.25 2.0625V13.875C11.25 14.5586 10.5117 14.9688 9.91016 14.6406L6 12.3438L2.0625 14.6406C1.46094 14.9688 0.75 14.5586 0.75 13.875V2.0625C0.75 1.35156 1.32422 0.75 2.0625 0.75H9.9375ZM9.9375 13.1094V2.22656C9.9375 2.14453 9.85547 2.0625 9.74609 2.0625H2.19922C2.11719 2.0625 2.0625 2.14453 2.0625 2.22656V13.1094L6 10.8125L9.9375 13.1094Z" fillOpacity="0.75"/>
                            </svg>
                            <h6 className='red-hover'>Мои закладки</h6>
                        </Link>
                        <Link to='/feed' onClick={handleLogOut} className='flex red-hover items-center gap-2'>
                            <svg width="15" height="13" viewBox="0 0 15 13" fill="#3E3232" xmlns="http://www.w3.org/2000/svg">
                                <path d="M4.375 11.125C4.83984 11.125 5.25 11.5352 5.25 12C5.25 12.4922 4.83984 12.875 4.375 12.875H2.625C1.14844 12.875 0 11.7266 0 10.25V3.25C0 1.80078 1.14844 0.625 2.625 0.625H4.375C4.83984 0.625 5.25 1.03516 5.25 1.5C5.25 1.99219 4.83984 2.375 4.375 2.375H2.625C2.13281 2.375 1.75 2.78516 1.75 3.25V10.25C1.75 10.7422 2.13281 11.125 2.625 11.125H4.375ZM13.7266 6.14844C14.082 6.47656 14.082 7.05078 13.7266 7.37891L10.2266 10.8789C9.89844 11.2344 9.32422 11.2344 8.99609 10.8789C8.64062 10.5508 8.64062 9.97656 8.99609 9.64844L10.9922 7.625H5.25C4.75781 7.625 4.375 7.24219 4.375 6.75C4.375 6.28516 4.75781 5.875 5.25 5.875H10.9922L8.99609 3.87891C8.64062 3.55078 8.64062 2.97656 8.99609 2.64844C9.32422 2.29297 9.89844 2.29297 10.2266 2.64844L13.7266 6.14844Z" fillOpacity="0.75"/>
                            </svg>
            ...
            <div className="dropdown">
                ...
                <div className="dropdown-pages p-4 gap-4 left-4">
                    <Link to='/signin' className='flex red-hover items-center gap-2'>
                            <svg width="15" height="13" viewBox="0 0 15 13" fill="#3E3232" xmlns="http://www.w3.org/2000/svg">
                                <path d="M4.375 11.125C4.83984 11.125 5.25 11.5352 5.25 12C5.25 12.4922 4.83984 12.875 4.375 12.875H2.625C1.14844 12.875 0 11.7266 0 10.25V3.25C0 1.80078 1.14844 0.625 2.625 0.625H4.375C4.83984 0.625 5.25 1.03516 5.25 1.5C5.25 1.99219 4.83984 2.375 4.375 2.375H2.625C2.13281 2.375 1.75 2.78516 1.75 3.25V10.25C1.75 10.7422 2.13281 11.125 2.625 11.125H4.375ZM13.7266 6.14844C14.082 6.47656 14.082 7.05078 13.7266 7.37891L10.2266 10.8789C9.89844 11.2344 9.32422 11.2344 8.99609 10.8789C8.64062 10.5508 8.64062 9.97656 8.99609 9.64844L10.9922 7.625H5.25C4.75781 7.625 4.375 7.24219 4.375 6.75C4.375 6.28516 4.75781 5.875 5.25 5.875H10.9922L8.99609 3.87891C8.64062 3.55078 8.64062 2.97656 8.99609 2.64844C9.32422 2.29297 9.89844 2.29297 10.2266 2.64844L13.7266 6.14844Z" fillOpacity="0.75"/>
                            </svg>
