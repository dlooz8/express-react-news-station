...
const Navbar = () => {
  return (
    <div className='flex justify-between mx-48 my-12 items-center align-middle font-medium'>
        ...
        <div className="flex justify-between text-xs gap-8 bg-gray rounded-xl px-4 min-w-[400px] py-3">
            ...
            <input className="bg-gray min-w-[250px] min-h-[24px] outline-none" type="text" placeholder="Search Anything" />
