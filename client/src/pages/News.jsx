          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4 bg-gray rounded-xl p-4">
              <div className="flex gap-2">
                <img
                  src="https://t3.ftcdn.net/jpg/05/61/43/26/360_F_561432620_ghqin7jE48RP4B6JrOpCpio536LOeTVC.jpg"
                  alt="avatar"
              ...
              <p>
                ...
                Obcaecati nostrum maiores voluptates. Beatae fugiat magnam,
                molestias doloribus tenetur explicabo necessitatibus quibusdam
                ab aliquam, veniam quis est dolorem assumenda error similique?
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Molestiae tempora quis mollitia nisi, fugit eius accusantium
                dolorum. Aliquid sed neque vitae commodi, ullam culpa ducimus
                atque, dolor, adipisci nemo aperiam.
              </p>
            </div>
          </div>
