            ...
            <div className="2xl:mx-48 mx-32">
                ...
                <div key={index}>
                    <div className="flex flex-col justify-between p-3 shadow rounded-xl items-center w-[270px] 2xl:w-[360px] h-[340px] 2xl:h-[390px]">
                        <Link className="flex flex-col justify-between gap-2" to={`/news/${news.post_id}`}>
                            <img className="min-w-full max-h-[206px] object-cover rounded-xl" src={news.title_img} alt="popular" />
                            <h5 className="line-clamp-1 self-start px-3">{news.theme}</h5>
                            <Markdown className="markdown line-clamp-2 px-3">{news.text}</Markdown>
                        </Link>
                        <div className="flex justify-between items-center gap-4 bg-gray rounded-xl p-3 w-full">
                            ...
                            <div className="pr-2" onClick={() => handleDelete(news.post_id)}>
